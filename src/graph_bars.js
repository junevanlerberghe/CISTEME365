...
export default class Bars {
    constructor(game, pidGraph){
        ...
        // them bars
        this.bars = [MakeIndividualBar(this.gameWidth - 110),
            MakeIndividualBar(this.gameWidth - 74),
            MakeIndividualBar(this.gameWidth - 38)];
    ...
    updateHeight(){
        for (let idx = 0; idx < 3; idx++) {
            ...
            let height = up * (30000/500000)  // play w/ multipler ?
